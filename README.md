...
This repository contains small browser games built using only HTML, CSS and JavaScript.
...
The goal of this repository is to practice JavaScript and explore how simple games can be built directly in the browser without frameworks or game engines.


**Future improvements:**

Add more small games

Improve visual effects and animations

Add high score saving

Improve game UI and polish
